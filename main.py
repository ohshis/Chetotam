...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Команда /start — приветствие с инструкцией"""
    text = (
        "👋 *Привет\\!* Я бот\\-промптер\\.\n\n"
        "Я беру твой обычный запрос и превращаю его в "
        "чёткий, структурированный промпт, с которым ChatGPT, "
        "Claude, Gemini и другие нейросети справятся "
        "*в разы лучше*\\.\n\n"
        "━━━━━━━━━━━━━━━━━\n"
        "📝 *Как пользоваться:*\n\n"
        "1️⃣ Просто отправь мне свою задачу или идею обычным "
        "сообщением \\(на любом языке\\)\n"
        "2️⃣ Подожди пару секунд — я улучшу твой промпт\n"
        "3️⃣ Скопируй результат и вставь в любую нейросеть\n\n"
        "━━━━━━━━━━━━━━━━━\n"
        "💡 *Примеры запросов:*\n\n"
        "• _напиши пост в инсту про мой кофейный бизнес_\n"
        "• _помоги составить резюме_\n"
        "• _придумай идеи для подарка девушке на годовщину_\n"
        "• _объясни мне квантовую физику_\n\n"
        "━━━━━━━━━━━━━━━━━\n"
        "🎯 *Совет:* чем больше деталей и контекста в запросе, "
        "тем точнее получится улучшенный промпт\\.\n\n"
        "Команды: /start — это сообщение, /help — краткая справка\\."
    )
